...
These models and their implementation are largely based off the models developed in [Hogan et al. (2017)](https://doi.org/10.1016/j.vaccine.2017.09.043)^[Hogan AB, Campbell PT, Blyth CC et al. Potential impact of a maternal vaccine for RSV: A mathematical modelling study. Vaccine. 2017; 35 (45): 6172-9.] ([implementation](https://github.com/abhogan/RSV_model)), [Giannini et al. (2024)](https://doi.org/10.1186/s12879-024-09400-2)^[Giannini F, Hogan AB, Sarna M et al. Modelling respiratory syncytial virus age-specific risk of hospitalisation in term and preterm infants. BMC Infectious Diseases. 2024; 24: 510.] ([implementation](https://github.com/fionagi/rsvmod)) and [Giannini et al. (2025)](https://doi.org/10.1016/j.vaccine.2025.127155)^[Giannini F, Hogan AB, Cameron E et al. Estimating the impact of Western Australia's first respiratory syncytial virus immunisation program for all infants: A mathematical modelling study. Vaccine. 2025; 56: 127155.] ([implementation](https://github.com/fionagi/rsvmod.imm)). Credit is due to the authors of the respective models.
