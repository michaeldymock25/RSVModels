...
#' @export
get_contact_matrix <- function(seed = 6824767){
  set.seed(seed)
  ...
  mixing_agg <- predict_setting_contacts(population = pop, contact_model = setting_models, age_breaks = pop$lower.age.limit)
